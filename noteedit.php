...
if (isset($_POST['modify'])) {
  ...
  $query4 = sprintf("UPDATE jegyzet SET jegyzetnev='%s', jegyzetszoveg='%s', jegyzetdatum='%s' WHERE id=%s AND felhasznaloid=%s",
                $jegyzetnev, $jegyzetszoveg, $jegyzetdatum, $id, $felhasznaloid);
...
@media screen and (max-width: 300px) {
    ...
    <li class="active"><a data-toggle="tab" href="">Notes</a></li>
    <li><a data-toggle="tab" href="">Pictures</a></li>
  </ul>
  ...
  <?php
            $querySelect3 = "SELECT jegyzetszoveg, jegyzetnev, jegyzetdatum FROM jegyzet WHERE felhasznaloid='$_SESSION[id]' AND id='$_GET[noteid]'";         
  ...
  <div class="imgcontainer">
    ...
    <div>
	<p><p>
    <h2><p class="b"> Edit note </p></h2>
    </div>

    <div class="container2">
      <label for="other"><b>Note name:</b></label>
      <input type="text" class="form-control" value="<?=$row['jegyzetnev']?>" name="jegyzetnev" >
	  	</div>
	<div class="container2">
      <label for="other"><b>Note text:</b></label>
      <textarea name="jegyzetszoveg" value="<?=$row['jegyzetszoveg']?>" ><?=$row['jegyzetszoveg']?> </textarea>
	</div>
	<div class="container2"
    ...
    <div  class="flex-container" style="background-color:#f1f1f1">
      <a href="home.php" class="cancelbtn btn btn-outline-danger" >Cancel</a>
						<button class="btn btn-outline-danger right" float="right">Delete note</button></td>
						<input type="hidden" name="delete" value="<?=$_GET['noteid']?>" />
    </div>
  </form>
</div>
